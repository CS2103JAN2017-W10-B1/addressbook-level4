...
<AnchorPane fx:id="placeHolder" style="-fx-background-color: LAVENDERBLUSH;" styleClass="anchor-pane-with-border" xmlns="http://javafx.com/javafx/8.0.111" xmlns:fx="http://javafx.com/fxml/1">
    ...
    <AnchorPane fx:id="mainPane" style="-fx-background-color: LAVENDERBLUSH;">
      <HBox AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="0.0" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="0.0">
         <children>
            <ImageView fitHeight="77.0" fitWidth="76.0" nodeOrientation="RIGHT_TO_LEFT" pickOnBounds="true" preserveRatio="true" HBox.hgrow="NEVER">
               <image>
              ...
              <TextArea fx:id="resultDisplay" editable="false" style="-fx-font-family: Avenir; -fx-font-size: 12; -fx-background-color: LAVENDERBLUSH; -fx-border-color: DEEPSKYBLUE; -fx-border-style: segments(10, 15, 15, 15)  line-cap round; -fx-border-radius: 5; -fx-border-width: 5;" styleClass="result-display" HBox.hgrow="ALWAYS">
               <HBox.margin>
                  <Insets />
               </HBox.margin>
            </TextArea>
...
<VBox xmlns="http://javafx.com/javafx/8.0.111" xmlns:fx="http://javafx.com/fxml/1">
    ...
    <children>
      <Label fx:id="tagListHeader" style="-fx-background-color: ALICEBLUE; -fx-border-color: DEEPSKYBLUE; -fx-border-radius: 3; -fx-border-width: 3;" text="\$Label" />
...
<HBox id="taskCardPane" fx:id="taskCardPane" opacity="0.75" prefHeight="120.0" prefWidth="522.0" style="-fx-border-radius: 5; -fx-border-width: 3; -fx-border-color: DARKSALMON; -fx-background-radius: 5; -fx-background-color: LAVENDERBLUSH;" xmlns="http://javafx.com/javafx/8.0.111" xmlns:fx="http://javafx.com/fxml/1">
    <children>
        <GridPane prefHeight="117.0" prefWidth="357.0" HBox.hgrow="ALWAYS">
            ...
            <ColumnConstraints fillWidth="false" hgrow="SOMETIMES" maxWidth="233.0" minWidth="150.0" prefWidth="233.0" />
            </columnConstraints>
            <children>
                      ...
                      <VBox alignment="CENTER_LEFT" prefHeight="147.0" prefWidth="346.0">
                        ...
                        <HBox>
                           ...
                           <children>
                              ...
                              <Label fx:id="pastDue" minWidth="60.0" prefHeight="12.0" style="-fx-text-fill: red; -fx-font-size: 14; -fx-font-family: Avenir;" text="\$pastDue" textFill="#f20000">
                                 <font>
            ...
            <VBox alignment="TOP_RIGHT" maxWidth="239.0" prefHeight="117.0" prefWidth="239.0" GridPane.columnIndex="1">
               <children>
                  ...
                  <HBox>
                     ...
                     <children>
                        <Label fx:id="startTime" prefHeight="19.0" prefWidth="140.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" text="\$startTime">
                           <font>
                              <Font name="Avenir Roman" size="11.0" />
                           </font>
                        </Label>
                              <Label fx:id="time" alignment="CENTER_RIGHT" prefHeight="19.0" prefWidth="100.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" styleClass="cell_small_label" text="\$time">
                           <font>
                              <Font name="Avenir Roman" size="11.0" />
                           </font>
                        </Label>
                  ...
                  <HBox>
                     ...
                     <children>
                        <Label fx:id="startDate" prefHeight="19.0" prefWidth="140.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" text="\$startDate">
                           <font>
                              <Font size="11.0" />
                           </font>
                        </Label>
                        <Label fx:id="date" alignment="CENTER_RIGHT" prefHeight="19.0" prefWidth="120.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" styleClass="cell_small_label" text="\$date">
                           <font>
                              <Font size="11.0" />
                           </font>
                           <HBox.margin>
...
<VBox prefWidth="251.0" xmlns="http://javafx.com/javafx/8.0.111" xmlns:fx="http://javafx.com/fxml/1">
    ...
    <children>
      <Label fx:id="taskListHeader" alignment="CENTER" contentDisplay="CENTER" prefHeight="29.0" prefWidth="270.0" style="-fx-border-color: DEEPSKYBLUE; -fx-border-radius: 5; -fx-border-width: 3; -fx-background-color: ALICEBLUE;" text="\$header" textAlignment="CENTER" VBox.vgrow="ALWAYS">
         <VBox.margin>
            <Insets />
         </VBox.margin>
      </Label>
