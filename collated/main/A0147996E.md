...
<HBox id="cardPane" fx:id="tagCardPane" prefHeight="45.0" prefWidth="168.0" style="-fx-background-color: LAVENDERBLUSH; -fx-border-color: SALMON; -fx-border-width: 2; -fx-border-radius: 5;" xmlns="http://javafx.com/javafx/8.0.111" xmlns:fx="http://javafx.com/fxml/1">
    <children>
        <GridPane prefHeight="146.0" prefWidth="200.0" HBox.hgrow="ALWAYS">
            <columnConstraints>
                <ColumnConstraints hgrow="NEVER" maxWidth="134.0" minWidth="30.0" />
            <ColumnConstraints hgrow="ALWAYS" maxWidth="1.7976931348623157E308" minWidth="180.0" prefWidth="122.0" />
            </columnConstraints>
            <children>
            <Label fx:id="index" prefHeight="22.0" prefWidth="30.0" style="-fx-font-family: Avenir; -fx-font-size: 16;" text="\$id">
               <GridPane.margin>
                  <Insets left="10.0" />
               </GridPane.margin></Label>
            <Label fx:id="name" prefHeight="24.0" style="-fx-font-size: 16; -fx-font-family: Avenir;" text="\$tag" GridPane.columnIndex="1" />
            </children>
         <rowConstraints>
            <RowConstraints />
         </rowConstraints>
...
<HBox id="taskCardPane" fx:id="taskCardPane" prefHeight="120.0" prefWidth="522.0" style="-fx-border-radius: 5; -fx-border-width: 3; -fx-border-color: DARKSALMON; -fx-background-radius: 5; -fx-background-color: LAVENDERBLUSH;" xmlns="http://javafx.com/javafx/8.0.111" xmlns:fx="http://javafx.com/fxml/1">
    <children>
        <GridPane prefHeight="113.0" prefWidth="516.0" HBox.hgrow="ALWAYS">
            ...
            <ColumnConstraints halignment="RIGHT" hgrow="NEVER" maxWidth="240.0" minWidth="150.0" prefWidth="240.0" />
            </columnConstraints>
            <children>
            <HBox prefHeight="136.0" prefWidth="334.0" GridPane.hgrow="ALWAYS">
               <children>
                      <VBox alignment="CENTER_LEFT" prefHeight="147.0" prefWidth="346.0" HBox.hgrow="ALWAYS">
                        ...
                        <HBox>
                           <children>
                              <Label fx:id="index" minWidth="20.0" prefHeight="17.0" prefWidth="28.0" style="-fx-font-family: Avenir; -fx-font-size: 15;" styleClass="cell_big_label" text="\$id" HBox.hgrow="NEVER">
                                 <HBox.margin>
                                    <Insets top="2.0" />
                                 </HBox.margin>
                                 <font>
                                 ...
                                 <effect>
                                    <Glow />
                                       ...
                                       <Label fx:id="name" minWidth="150.0" prefHeight="20.0" prefWidth="149.0" style="-fx-font-family: Avenir; -fx-font-size: 15; -fx-font-style: bold;" styleClass="cell_big_label" text="\$taskName" HBox.hgrow="ALWAYS">
                                 <font>
                                    <Font name="Avenir Roman" size="14.0" />
                                 </font>
                                 <HBox.margin>
                               ...
                               <Label fx:id="tag" minWidth="80.0" prefHeight="20.0" prefWidth="101.0" style="-fx-font-family: Avenir; -fx-font-size: 14;" styleClass="cell_small_label" text="\$list" HBox.hgrow="ALWAYS">
                                 <HBox.margin>
                                    <Insets top="3.0" />
                                 </HBox.margin>
                                 <font>
            ...
            <VBox alignment="CENTER_RIGHT" fillWidth="false" maxWidth="239.0" prefHeight="117.0" prefWidth="239.0" GridPane.columnIndex="1" GridPane.halignment="RIGHT" GridPane.hgrow="NEVER">
               <children>
                  <Label fx:id="isFinished" alignment="CENTER_RIGHT" contentDisplay="RIGHT" prefHeight="17.0" prefWidth="122.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" styleClass="cell_small_label" text="\$isFinished" VBox.vgrow="NEVER">
                     <VBox.margin>
                        <Insets top="8.0" />
                     </VBox.margin>
                     <font>
                     ...
                     <children>
                        <Label fx:id="startTime" contentDisplay="RIGHT" minWidth="140.0" prefHeight="19.0" prefWidth="140.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" text="\$startTime" HBox.hgrow="NEVER">
                           <font>
                              ...
                              <Label fx:id="time" alignment="CENTER_RIGHT" contentDisplay="RIGHT" minWidth="100.0" prefHeight="19.0" prefWidth="100.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" styleClass="cell_small_label" text="\$time" textAlignment="JUSTIFY" HBox.hgrow="NEVER">
                           <font>
                              <Font name="Avenir Roman" size="11.0" />
                           </font>
                        </Label>
                  ...
                  <HBox>
                     ...
                     <children>
                        <Label fx:id="startDate" contentDisplay="RIGHT" minWidth="140.0" prefHeight="19.0" prefWidth="140.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" text="\$startDate" HBox.hgrow="NEVER">
                           <font>
                              <Font size="11.0" />
                           </font>
                        </Label>
                        <Label fx:id="date" alignment="CENTER_RIGHT" contentDisplay="RIGHT" minWidth="100.0" prefHeight="19.0" prefWidth="120.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" styleClass="cell_small_label" text="\$date" HBox.hgrow="NEVER">
                           <font>
                              <Font size="11.0" />
                           </font>
                           <HBox.margin>
                  ...
                  <HBox minWidth="80.0">
                     ...
                     <children>
                        <Label fx:id="isRecurring" alignment="TOP_CENTER" contentDisplay="RIGHT" prefHeight="19.0" prefWidth="120.0" style="-fx-font-family: Avenir; -fx-font-size: 12;" styleClass="cell_small_label" text="\$isRecurring" HBox.hgrow="NEVER">
                           <font>
                              <Font size="11.0" />
                           </font>
                           <HBox.margin>
